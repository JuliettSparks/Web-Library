<?php
    ...
    if($_SESSION['id']==null){
     ...
     $query="SELECT * from libros WHERE asignatura like '$subject%'";

     $query2="SELECT * from libros WHERE asignatura like '$subject%'";
...
<body>
    ...
    <?php if($data['id']=="" || $subject==""){?>
        <h2>No se encontraron libros de la Asignatura con ese Nombre</h2>
